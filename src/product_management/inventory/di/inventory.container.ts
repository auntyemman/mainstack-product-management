...
// Bind dependencies
inventoryContainer
  .bind<InventoryRepository>(INVENTORY_TYPES.InventoryRepository)
  .to(InventoryRepository)
  .inSingletonScope();
inventoryContainer
  .bind<InventoryService>(INVENTORY_TYPES.InventoryService)
  .to(InventoryService)
  .inSingletonScope();
inventoryContainer
  .bind<InventoryController>(INVENTORY_TYPES.InventoryController)
  .to(InventoryController)
  .inSingletonScope();
inventoryContainer
  .bind<InventoryEventListeners>(INVENTORY_TYPES.InventoryEventListeners)
  .to(InventoryEventListeners)
  .inSingletonScope();
